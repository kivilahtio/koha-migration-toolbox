package MMT::Voyager2Koha::Holding;
...
MMT::Voyager2Koha::Holding - Transform holdings
...
See MMT::Voyager2Koha::Holding::HAMK for example implementation

The transformation module:
- MUST set the id of this MMT::Voyager2Koha::Holding-object in-place
...
sub build($s, $xmlPtr, $b) {
  ...
  unless ($b->{holdingsTransformationModule}) {
    my $package = 'MMT::Voyager2Koha::Holding::'.MMT::Config::holdingsTransformationModule;
