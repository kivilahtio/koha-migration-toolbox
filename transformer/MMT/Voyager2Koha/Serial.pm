package MMT::Voyager2Koha::Serial;
...
MMT::Voyager2Koha::Serial - Transforms a bunch of Voyager data into Koha serials
...
sub setEnumerations($s, $o, $b) {
  MMT::Voyager2Koha::Serial::Enumerations::enumThenChron(@_);
}
