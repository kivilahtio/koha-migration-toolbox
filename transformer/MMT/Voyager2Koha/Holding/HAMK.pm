package MMT::Voyager2Koha::Holding::HAMK;
...
MMT::Voyager2Koha::Holding::HAMK - Transform holdings the HAMK-way
...
Sets the id-attribute of the MMT::Voyager2Koha::Holdings-record ASAP, so it can be accurately logged.

 @param {MMT::Voyager2Koha::Holding}
