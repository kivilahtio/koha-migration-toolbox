...
MMT_HOME="$MMT_HOME" perl migrate.pl --branchtransfers &> $MMT_HOME/logs/10-branchtransfers.log
MMT_HOME="$MMT_HOME" perl migrate.pl --load            &> $MMT_HOME/logs/11-load.log
