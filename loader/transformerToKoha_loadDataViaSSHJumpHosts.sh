...
KOHA_LOADER_DIR="/home/koha/KohaLoader"

#Deploy the loader program
scp -r loader/KohaLoader $KOHA_HOST:$KOHA_LOADER_DIR
test $? != 0 && echo "Uploading the Koha Loader failed!" && exit 9
...
ssh $KOHA_HOST "cd /home/koha && tar -xzf /home/koha/kohaData.tar.gz && rm /home/koha/kohaData.tar.gz"
...
#Start loading
ssh $KOHA_HOST "$KOHA_LOADER_DIR/load.sh /home/koha/KohaImports"
